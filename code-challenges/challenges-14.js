...
const replaceWords = (str) => {
    ...
    strArr[strArr.indexOf('I')] = 'We'
    strArr[strArr.indexOf('am')] = 'are'
    strArr[strArr.indexOf('was')] = 'were'
    return strArr.join(" ")
}
// -------------------------------------------------------------------------------------------------------
...
const letterCounter = (str) => {
    ...
    for (let letter of str){
        if(!lettersArray.includes(letter) && letter!==' '){
    ...
    let strWithComma = (Object.entries(letterObject)).join('')
    let characterToRemove = ",";
    let stringWithoutComma = strWithComma.replace(new RegExp(characterToRemove, 'g'), '');
